        ...
        <div className="w-full max-w-md">
          ...
          <div className="mb-12">
            <div className="flex items-center space-x-3">
              ...
              />
              <span className="text-white text-xl font-semibold tracking-wide">Human Catalyst Beacon</span>
            </div>
          </div>
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-[#0a0a0a] text-white/60">Or continue with</span>
            </div>
          </div>
          ...
          <button
            ...
            disabled={loading}
            className="w-full py-3.5 px-4 bg-white/5 border border-white/10 hover:bg-white/10 text-white font-medium rounded-xl transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center space-x-3 group"
          >
