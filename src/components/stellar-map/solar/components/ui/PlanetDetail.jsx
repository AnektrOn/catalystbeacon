...
export default function PlanetDetail() {
  ...
  const shouldDisplayDetails = cameraState === 'DETAIL_VIEW' && displayedPlanet;
  ...
  return (
    <div
      ...
      className="absolute left-5 right-5 top-20 mt-4 w-[400px] z-10 transition-all duration-500 ease-out"
      style={{
