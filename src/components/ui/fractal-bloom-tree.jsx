...
// Fractal Bloom Canvas Component (named export for use as background slot)
export const FractalBloomCanvas = () => {
    ...
    return (
        <canvas
            ref={canvasRef}
            className="absolute inset-0 z-0 w-full h-full bg-[#020617]" />
    );
};
...
const FractalBloomHero = () => {
    ...
    return (
        <div
            ...
            <FractalBloomCanvas />
            <div
                className="absolute inset-0 bg-gradient-to-t from-[#020617] via-transparent to-transparent z-10"></div>
