-- ============================================
-- Fix 42702 (ambiguous column) in generate_roadmap_nodes
-- ============================================
-- complete_lesson_transaction calls generate_roadmap_nodes; if that function
-- has unqualified column refs that match RETURNS TABLE names, PostgREST returns 42702.
-- This migration re-applies generate_roadmap_nodes with all refs qualified.
-- Run this on the Supabase project (SQL Editor or push migrations).
-- ============================================
...
COMMENT ON FUNCTION generate_roadmap_nodes(UUID, TEXT, INT) IS
  'Generates roadmap nodes by institute priority. All column refs qualified to avoid 42702.';
